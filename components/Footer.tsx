...
export default function Footer() {
  return (
    <footer className="pb-10 md:px-5 md:pb-20 mt-2">
      <section className="flex flex-row items-center justify-around text-pretty border-y py-10 text-center">
        ...
        <div className="">
          <span className="text-sm font-medium md:text-lg">100% OEM Products</span>
        </div>
        ...
        <div className="grid grid-cols-1 gap-8 md:grid-cols-3">
          ...
          <div>
            ...
            <div className="mt-2 flex space-x-4">
              ...
              <Link
                href="https://www.instagram.com/k_factory_23/?hl=en"
                className="text-sm hover:underline"
              >
                Instagram
              </Link>
          ...
          <div>
            ...
            <a
              href="https://maps.app.goo.gl/Vvx45h85WHnTyRHJ8"
              target="_blank"
              rel="noopener noreferrer"
